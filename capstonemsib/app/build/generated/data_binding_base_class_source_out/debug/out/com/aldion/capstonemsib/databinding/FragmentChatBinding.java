...
public final class FragmentChatBinding implements ViewBinding {
  ...
  public static FragmentChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.messageList;
      MessageListView messageList = ViewBindings.findChildViewById(rootView, id);
      if (messageList == null) {
        break missingId;
      }

      id = R.id.messagesHeaderView;
      MessageListHeaderView messagesHeaderView = ViewBindings.findChildViewById(rootView, id);
